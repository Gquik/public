package com.gqk.gquikribbon.controller;
...
public class ServiceController {
    ...
    public String consumerServiceRibbon(){
        String result = this.restTemplate.getForObject("http://gquik-service1/gquik/hello",  String.class);
        return result;
    }

    public String consumerServiceRibbonFallback() {
        return "consumerServiceRibbon异常，端口：" + port + "，Name=" + "gquik-service1";
    }
}
